<template lang="html">
  <div class="Home">
    ...
    <nav class="navbar is-black has-shadow">
      ...
      <div id="navbarExampleTransparentExample" class="is-black navbar-menu" v-bind:class="{ 'is-active' : showNav }">
        ...
        <div class="navbar-end">
          <div class="navbar-item">
            <div class="field is-grouped">
              <p class="control">
                <a class="button is-dark is-outlined" @click="add_modal = true">
                  Add new todo
                </a>
              </p>
            </div>
    ...
    <div class="section">
      <div class="boards">
        <div class="columns">
          ...
          <b-modal :active.sync="details_modal" :width="380">
    ...
    <b-modal :active.sync="add_modal" :width="380">
        ...
        <form @submit="addTodo">
          ...
          <section class="modal-card-body">
            ...
            <b-field label="Todo Point">
              <b-input placeholder="Your todo point" v-model="newTodo.point" required>
              </b-input>
            </b-field>

            <b-field label="Todo Description">
              <b-input type="textarea" placeholder="Description type here.." v-model="newTodo.description" required>
              </b-input>
            </b-field>

            <b-field label="Todo Assign">
              <b-input placeholder="Assign to.." v-model="newTodo.assign" required>
              </b-input>
            </b-field>
          </section>
          <footer class="modal-card-foot">
    ...
    <sweet-modal icon="success" ref="alert_success">Success!
      <br>{{ greet }}</sweet-modal>
